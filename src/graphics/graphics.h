...
public:
	...
	/// write the scenegraph to the dynamic drawlist
	/// will traverse scenegraph, update child transforms, add drawables to dynamic drawlist
	virtual void AddDynamicNode(SceneNode & node) = 0;

	/// write the scenegraph to the static drawlist (slow)
	/// usually once after static scene creation
	/// will generate aabb tree for scene culling acceleration
	virtual void AddStaticNode(SceneNode & node) = 0;

	/// clear drawlist generated by AddDynamicNode calls
	virtual void ClearDynamicDrawList() = 0;

	/// clear drawlist generated by AddStaticNode calls
